...
import { NodeConfig, StrokeStyle } from '../common/configs';
...
export declare function getAnimationSpeed(key: string, config: StrokeStyle, scale: number): Record<string, number | undefined>;
