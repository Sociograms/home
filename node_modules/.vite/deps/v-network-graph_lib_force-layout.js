...
// node_modules/v-network-graph/lib/force-layout.js
...
var N = (u, t, e) => t in u ? D(u, t, { enumerable: true, configurable: true, writable: true, value: e }) : u[t] = e;
var m2 = (u, t) => {
  for (var e in t || (t = {}))
...
var K = class {
  ...
  activate(t) {
    const { nodePositions: e, nodes: i, edges: a2, emitter: n } = t;
    let { nodeLayouts: d, nodeLayoutMap: y3 } = this.buildNodeLayouts(i.value, e);
    const h = this.createSimulation(
      d,
      this.forceLayoutEdges(a2.value, i.value)
    );
    this.onTick = () => {
      var s, l, c2, o, f;
      for (const r of d) {
        ...
        if (g) {
          const L = (l = r.x) != null ? l : 0, j = (c2 = r.y) != null ? c2 : 0;
    ...
    const v = () => {
      ...
      if (this.options.noAutoRestartSimulation)
        for (const [c2, o] of Object.entries(s)) {
          const f = (l = e.value) == null ? void 0 : l[c2];
          f.x = o.x, f.y = o.y;
        }
      else {
        for (const [c2, o] of Object.entries(s)) {
      ...
      var l;
      for (const [c2, o] of Object.entries(s)) {
        const f = this.getNodeLayout(e, c2), r = (l = y3 == null ? void 0 : y3[c2]) != null ? l : { x: 0, y: 0 };
        f.value.fixed || this.options.positionFixedByDrag ? (r.fx = o.x, r.fy = o.y, f.value.fixed = true) : (r.x = o.x, r.y = o.y, delete r.fx, delete r.fy);
      }
      v();
    }, b = ({ node: s, event: l }) => {
      if (this.options.positionFixedByClickWithAltKey && l.altKey) {
        const c2 = this.getNodeLayout(e, s);
        let o = y3 == null ? void 0 : y3[s];
        o || (o = { id: s, x: 0, y: 0 }, y3[s] = o), c2.value.fixed ? (delete c2.value.fixed, o.x = o.fx || o.x, o.y = o.fy || o.y, delete o.fx, delete o.fy) : (c2.value.fixed = true, o.fx = o.x, o.fy = o.y), v();
      }
    }, E = watch(
      () => [
        Object.keys(i.value),
        ...
        Object.values(a2.value).map((s) => `${s.source}=${s.target}`)
      ],
      () => {
        ({ nodeLayouts: d, nodeLayoutMap: y3 } = this.buildNodeLayouts(i.value, e)), h.nodes(d);
        const s = h.force("edge");
        s && s.links(this.forceLayoutEdges(a2.value, i.value)), v();
      }
    );
  ...
  createSimulation(t, e) {
    if (this.options.createSimulation)
      return this.options.createSimulation(src_exports, t, e);
    {
      const i = link_default(e).id((a2) => a2.id);
      return simulation_default(t).force("edge", i.distance(100)).force("charge", manyBody_default()).force("collide", collide_default(50).strength(0.2)).force("center", center_default().strength(0.05)).alphaMin(1e-3);
    }
  }
  buildNodeLayouts(t, e) {
    const i = Object.keys(t).filter((d) => !(d in e.value)), a2 = this.forceNodeLayouts(e.value, i), n = Object.fromEntries(a2.map((d) => [d.id, d]));
    return { nodeLayouts: a2, nodeLayoutMap: n };
  }
  forceNodeLayouts(t, e) {
    const i = Object.entries(t).map(([a2, n]) => n.fixed ? S(m2({ id: a2 }, n), { fx: n.x, fy: n.y }) : m2({ id: a2 }, n));
    return e.map((a2) => ({ id: a2 })).forEach((a2) => i.push(a2)), i;
  }
...
//# sourceMappingURL=v-network-graph_lib_force-layout.js.map
